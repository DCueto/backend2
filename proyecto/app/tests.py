...
class SimpleTest(TestCase):
	...
	def setUp(self):
		...
		self.usuario = User.objects.create_user(username="daniel", password="1234")
	...
	def test_es_popular(self):
		...
		#usuario = User.objects.create_user(username="daniel", password="1234")
	...
	def test_views(self):
		...
		self.assertTrue(self.client.login(username="daniel", password="1234"))
